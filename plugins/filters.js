...
Asena.addCommand({on: 'text', fromMe: false}, (async (message, match) => {
        if (!!message.mention && message.mention[0] == '916238139539@s.whatsapp.net') {
...
const array = ['Abdu','Bot','Friend','Friends','Hello','help','DEMIGOD','Demigod','menu','Myr','Myre','thyr','thyre','Nanba','Nanban','Lub u','Anu','alive','Sorry','I love you','Good night','Good morning','Nandhu','Good afternoon','Sam','AK','DEMIGOD','Demigod','Akash','I love u','Zam']
array.map( async (a) => {
